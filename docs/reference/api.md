...
| Analytics | `app/src/app/api/analytics/{latency,reliability,cost,dns,dependencies}/route.ts` | Aggregations via `app/src/lib/analytics/*` |
...
| 분석 | `app/src/app/api/analytics/{latency,reliability,cost,dns,dependencies}/route.ts` | `app/src/lib/analytics/*` 기반 집계 |
