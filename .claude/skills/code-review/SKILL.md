...
This is an npm-workspaces monorepo: `app/` (Next.js 16), `collector/` (Lambda), `infra/` (CDK). Apply workspace-appropriate criteria (e.g., accessibility for `app/`, IAM least-privilege for `infra/`).
