...
## Key Files
- `src/app/` — App Router pages: overview (`/`), topology, network, flows, paths, workload, monitors, insights, history, alerts, anomalies, diagnose, agents, cost, reports, search, settings, chat-popup, login
