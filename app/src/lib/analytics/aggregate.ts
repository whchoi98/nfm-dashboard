...
/** Health thresholds for retransmission/timeout RATE (events per GB) — shared by monitor chips + edge-health matrix. */
export const RETRANS_RATE_WARN = 5;
export const RETRANS_RATE_DANGER = 10;
export const TIMEOUT_RATE_WARN = 5;
export const TIMEOUT_RATE_DANGER = 10;
